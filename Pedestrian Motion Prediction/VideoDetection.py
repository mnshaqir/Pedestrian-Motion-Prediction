...
# for video
# def input_videos():
#     cv2.VideoCapture("selected_video")
# cap = input_videos()

cap = cv2.VideoCapture("../Yolo with Video/Video/8th.mp4")
...
while True:
    ...
    # frame = cvzone.overlayPNG(frame, imgGraphics, (500, 60))
    # Resize Video
    ...
    # cvzone.putTextRect(resize_frame, f' Count: {len(totalCount)}', (700, 50))
    cvzone.putTextRect(resize_frame, f'Warning ! {len(totalCount)}', (700, 50), colorR=(50, 50, 255))
